...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Bankr Master", None))
        self.label_3.setText(_translate("Dialog", "Bank Code", None))
        self.label_4.setText(_translate("Dialog", "BankNamel", None))
